  ...
  const CHAPTERS = [
    ...
    },
    {
      ...
      steps: [
        ...
        { sel:'#panel-inner',   title:'Lire la fiche ennemie',     text:'Tu vois les territoires de Grèce & Balkans. Le point coloré indique le propriétaire. Pour attaquer une divinité, <strong>clique sur son nom dans le dock</strong> — ici Athéna — pour voir le bouton d\'attaque.', action:'click-deity-athena' },
