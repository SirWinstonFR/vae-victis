...
const CORP_BASE = {
  apple:     { ticker:'AAPL', nom:'Apple Inc.',         secteur:'Big Tech',  couleur:'#a0a8b8', logo:'https://i.imgur.com/N8sDGhG.png', icon:'🍎', desc:'Devices, logiciels et services premium. Capitalisation la plus haute au monde.' },
  microsoft: { ticker:'MSFT', nom:'Microsoft Corp.',    secteur:'Big Tech',  couleur:'#4a8ad4', logo:'https://i.imgur.com/q7mJhND.png', icon:'🪟', desc:'Cloud Azure, Office 365, Xbox. Domination du marché B2B mondial.' },
  google:    { ticker:'GOOGL', nom:'Alphabet Inc.',     secteur:'Big Tech',  couleur:'#e8b030', logo:'https://i.imgur.com/IVxULbw.png', icon:'🔍', desc:'Moteur de recherche, YouTube, publicité numérique et IA.' },
  amazon:    { ticker:'AMZN', nom:'Amazon.com Inc.',    secteur:'Big Tech',  couleur:'#f0a020', logo:'https://i.imgur.com/Tpbqaal.png', icon:'📦', desc:'E-commerce mondial, cloud AWS, logistique et streaming.' },
  meta:      { ticker:'META', nom:'Meta Platforms',     secteur:'Big Tech',  couleur:'#1a7adc', logo:'https://i.imgur.com/9qM8g37.png', icon:'👁', desc:'Facebook, Instagram, WhatsApp. 3 milliards d\'utilisateurs actifs.' },
  nvidia:    { ticker:'NVDA', nom:'NVIDIA Corp.',       secteur:'Big Tech',  couleur:'#76b900', logo:'https://i.imgur.com/Yq49nXG.png', icon:'⚡', desc:'Puces GPU, IA et data centers. Moteur de la révolution IA.' },
